...
const Fruits = () => {
  ...
  const mango: string[] = [
    ...
    "망고는 열대과일의 특성상 쉽게 상하기 때문에 국내에 들어오는 생 망고는 현지에서 먹는 것과 맛이 꽤 다르고 가격도 생산지에서 팔리는 가격에 비하면 어마어마하게 비싸다. 이 때문에 국내에 수입되는 망고의 태반은 과육만 따로 분리하여 냉동하거나 말리는 등 가공을 한 제품이다.",
